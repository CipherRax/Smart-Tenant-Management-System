...
"[project]/components/SignUpadminTwo.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase.types.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function AdminLoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: authData, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: credentials.email,
                password: credentials.password
            });
            if (authError) throw authError;
            // Check if user is admin
            const { data: user, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role, status').eq('email', credentials.email).single();
            if (userError) throw userError;
            if (user.role !== 'admin') {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
            ...
            // Update last login
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').update({
                last_login_at: new Date().toISOString()
            }).eq('email', credentials.email);
            // Log login attempt
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('login_attempts').insert({
                email: credentials.email,
                success: true
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4a8c0698._.js.map