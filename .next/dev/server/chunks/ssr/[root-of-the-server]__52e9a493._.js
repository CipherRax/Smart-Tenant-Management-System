...
const supabaseAnonKey = ("TURBOPACK compile-time value", "sb_publishable_jncibUQ6WacXrET4IiY-nA_enrRVrsS");
...
function AdminLoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: user, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role, status').eq('email', credentials.email).single();
            ...
            // Update last login
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').update({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52e9a493._.js.map