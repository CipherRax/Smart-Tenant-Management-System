...
function VerifyEmailPage() {
    ...
    const [hasCheckedStorage, setHasCheckedStorage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VerifyEmailPage.useEffect": ()=>{
            if (hasCheckedStorage && !email) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('No registration found. Please register first.');
                setTimeout({
                    "VerifyEmailPage.useEffect": ()=>{
                        router.push('/signIn');
                    }
    ...
    const handleResendEmail = async ()=>{
        if (!email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('No email address found');
            return;
        }
        setIsResending(true);
        try {
            ...
            if (error) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to resend verification email');
            } else {
                setResendSuccess(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Verification email resent! Check your inbox.');
                setTimeout(()=>{
    ...
    const handleCheckVerification = async ()=>{
        if (!email) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Checking verification status...');
        try {
            ...
            if (data?.user?.email_confirmed_at) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Email verified! You can now sign in.');
            ...
            if (error.message?.includes('Invalid login credentials')) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Account exists. Please use the verification link from your email.');
            } else if (error.message?.includes('Email not confirmed')) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Email not confirmed yet. Please check your inbox.');
            } else {
...
_s(VerifyEmailPage, "En4S58cy5F/4vk+P8SCk5d65SPY=", false, function() {
    return [
...
//# sourceMappingURL=_9c97d6fd._.js.map