...
function AdminLoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: user, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role, status').eq('email', credentials.email).single();
...
//# sourceMappingURL=_ff91d4ba._.js.map