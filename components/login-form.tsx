          ...
          <form className="p-6 md:p-8">
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className={`text-2xl font-bold text-amber-800 ${dancing.className}`}>Welcome back 👋</h1>
                <p className={`text-2xl text-balance text-center text-amber-700/80 ${vibes.className}`}>
                  Login to your <br/>Ellyon&apos;s apartments account
                </p>
              </div>
              <Field>
              ...
              <Field>
                <div className="flex items-center">
                  <FieldLabel htmlFor="password" className={`text-2xl ${dancing.className}`}>Password</FieldLabel>
                  <a
                    href="#"
              ...
              <FieldDescription className={`text-center text-2xl ${vibes.className}`}>
                Don&apos;t have an account? <a href="#">Contact the Admin</a>
              </FieldDescription>
            </FieldGroup>
          </form>
